 ...
 */
 public class EmptyTree<K extends Comparable<K>,V> implements Tree<K,V> {
	...
	//create a new non emptyTree
	public NonEmptyTree<K, V> insert(K key, V value) {
		return new NonEmptyTree<K, V>(key, value, new EmptyTree<K, V>(), new EmptyTree<K, V>());
	}

	//deleting from an empty tree returns itself
	...
	//subTree of empty tree is itself
